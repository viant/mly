...
type Endpoint struct {
	...
	// WriteTimeoutMs (and WriteTimeout) are the timeout for writing a response to the client.
	// Each request is given a maximum timeout of WriteTiemout - 1 millisecond.
