...
type ConfigProto struct {
	...
	// number.
	DeviceCount map[string]int32 `protobuf:"bytes,1,rep,name=device_count,json=deviceCount,proto3" json:"device_count,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
type CallableOptions struct {
	...
	// cuStreamSynchronize()).
	FeedDevices  map[string]string `protobuf:"bytes,6,rep,name=feed_devices,json=feedDevices,proto3" json:"feed_devices,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	FetchDevices map[string]string `protobuf:"bytes,7,rep,name=fetch_devices,json=fetchDevices,proto3" json:"fetch_devices,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_tensorflow_core_protobuf_config_proto_rawDesc = "" +
	"\n" +
	...
	"\x18org.tensorflow.frameworkB\fConfigProtosP\x01ZUgithub.com/tensorflow/tensorflow/tensorflow/go/core/protobuf/for_core_protos_go_proto\xf8\x01\x01b\x06proto3"

var (
	file_tensorflow_core_protobuf_config_proto_rawDescOnce sync.Once
	file_tensorflow_core_protobuf_config_proto_rawDescData []byte
)
...
func file_tensorflow_core_protobuf_config_proto_rawDescGZIP() []byte {
	file_tensorflow_core_protobuf_config_proto_rawDescOnce.Do(func() {
		file_tensorflow_core_protobuf_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_core_protobuf_config_proto_rawDesc), len(file_tensorflow_core_protobuf_config_proto_rawDesc)))
	})
...
var file_tensorflow_core_protobuf_config_proto_goTypes = []any{
...
func file_tensorflow_core_protobuf_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_core_protobuf_config_proto_rawDesc), len(file_tensorflow_core_protobuf_config_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   20,
			NumExtensions: 0,
			NumServices:   0,
