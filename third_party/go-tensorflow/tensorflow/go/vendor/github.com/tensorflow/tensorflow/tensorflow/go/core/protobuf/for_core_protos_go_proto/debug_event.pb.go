...
func (x *DebugEvent) GetWhat() isDebugEvent_What {
	if x != nil {
		return x.What
	}
	return nil
...
func (x *DebugEvent) GetDebugMetadata() *DebugMetadata {
	if x != nil {
		if x, ok := x.What.(*DebugEvent_DebugMetadata); ok {
...
func (x *DebugEvent) GetSourceFile() *SourceFile {
	if x != nil {
		if x, ok := x.What.(*DebugEvent_SourceFile); ok {
			return x.SourceFile
		}
	}
	return nil
...
func (x *DebugEvent) GetStackFrameWithId() *StackFrameWithId {
	if x != nil {
		if x, ok := x.What.(*DebugEvent_StackFrameWithId); ok {
...
func (x *DebugEvent) GetGraphOpCreation() *GraphOpCreation {
	if x != nil {
		if x, ok := x.What.(*DebugEvent_GraphOpCreation); ok {
...
func (x *DebugEvent) GetDebuggedGraph() *DebuggedGraph {
	if x != nil {
		if x, ok := x.What.(*DebugEvent_DebuggedGraph); ok {
...
func (x *DebugEvent) GetExecution() *Execution {
	if x != nil {
		if x, ok := x.What.(*DebugEvent_Execution); ok {
			return x.Execution
		}
	}
	return nil
...
func (x *DebugEvent) GetGraphExecutionTrace() *GraphExecutionTrace {
	if x != nil {
		if x, ok := x.What.(*DebugEvent_GraphExecutionTrace); ok {
...
func (x *DebugEvent) GetGraphId() string {
	if x != nil {
		if x, ok := x.What.(*DebugEvent_GraphId); ok {
			return x.GraphId
		}
	}
	return ""
...
func (x *DebugEvent) GetDebuggedDevice() *DebuggedDevice {
	if x != nil {
		if x, ok := x.What.(*DebugEvent_DebuggedDevice); ok {
...
const file_tensorflow_core_protobuf_debug_event_proto_rawDesc = "" +
	"\n" +
	...
	"\x13org.tensorflow.utilB\x10DebugEventProtosP\x01ZUgithub.com/tensorflow/tensorflow/tensorflow/go/core/protobuf/for_core_protos_go_proto\xf8\x01\x01b\x06proto3"

var (
	file_tensorflow_core_protobuf_debug_event_proto_rawDescOnce sync.Once
	file_tensorflow_core_protobuf_debug_event_proto_rawDescData []byte
)
...
func file_tensorflow_core_protobuf_debug_event_proto_rawDescGZIP() []byte {
	file_tensorflow_core_protobuf_debug_event_proto_rawDescOnce.Do(func() {
		file_tensorflow_core_protobuf_debug_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_core_protobuf_debug_event_proto_rawDesc), len(file_tensorflow_core_protobuf_debug_event_proto_rawDesc)))
	})
...
var file_tensorflow_core_protobuf_debug_event_proto_goTypes = []any{
...
func file_tensorflow_core_protobuf_debug_event_proto_init() {
	...
	file_tensorflow_core_protobuf_debug_event_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_core_protobuf_debug_event_proto_rawDesc), len(file_tensorflow_core_protobuf_debug_event_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
