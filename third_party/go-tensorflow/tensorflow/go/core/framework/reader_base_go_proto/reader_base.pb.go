...
const file_tensorflow_core_framework_reader_base_proto_rawDesc = "" +
	"\n" +
	...
	"\x18org.tensorflow.frameworkB\x10ReaderBaseProtosP\x01ZRgithub.com/tensorflow/tensorflow/tensorflow/go/core/framework/reader_base_go_proto\xf8\x01\x01b\x06proto3"

var (
	file_tensorflow_core_framework_reader_base_proto_rawDescOnce sync.Once
	file_tensorflow_core_framework_reader_base_proto_rawDescData []byte
)
...
func file_tensorflow_core_framework_reader_base_proto_rawDescGZIP() []byte {
	file_tensorflow_core_framework_reader_base_proto_rawDescOnce.Do(func() {
		file_tensorflow_core_framework_reader_base_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_core_framework_reader_base_proto_rawDesc), len(file_tensorflow_core_framework_reader_base_proto_rawDesc)))
	})
...
var file_tensorflow_core_framework_reader_base_proto_goTypes = []any{
...
func file_tensorflow_core_framework_reader_base_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_core_framework_reader_base_proto_rawDesc), len(file_tensorflow_core_framework_reader_base_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
